import {queryList,save,update,get,del} from '@/services/base/brand/service';
...
export default {
  namespace: 'basicdatabrand',
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/basicdata/brand' || location.pathname === '#{ROUTER}/') {
