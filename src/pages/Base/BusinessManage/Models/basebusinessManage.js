import {queryList,save,update,get,del} from '@/services/base/businessManage/service';
...
export default {
  namespace: 'basebusinessManage',
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/base/businessManage' || location.pathname === '#{ROUTER}/') {
